    ...
    <div className="p-6 bg-black/90 backdrop-blur-sm top-0 sticky z-20">
              ...
              <li className="text-white">
                <button onClick={goToTop}>
                  <img
                    src={Logo}
                    alt="Logo pasabaa"
                    className="object-scale-down h-12 invert"
                  />
                </button>
              </li>
            </ul>
          ...
          <div>
            <ul className="font-bold flex gap-4">
              <li className="text-white hover:text-gray-300 ease-in-out transition-all">
                <button onClick={goToTop}>Inicio</button>
              </li>
              ...
              {links.map((link) => {
                return (
                  <li
                    key={link.id}
                    className="text-white hover:text-gray-300 ease-in-out transition-all cursor-pointer"
                  >
                    <Link
                      activeClass="active"
                      spy
        ...
        <nav className="flex justify-between items-center">
          ...
          <div>
            <ul className="font-bold flex gap-4 mt-4">
              <li className="text-white text-3xl hover:text-gray-300 ease-in-out transition-all">
                <button
                  onClick={() => {
                    setshow(!show);
                  }}
      ...
      <AnimatePresence>
        {show && (
          <motion.div
            {...boxAnimation}
            className="w-6/12 mx-auto sm:w-10/12 hidden sm:block"
          >
