      ...
      <div className="h-full w-full inset-0 absolute flex items-center justify-center z-10 gap-16 sm:flex-col sm:p-16">
        <div>
          ...
          <h1 className="text-6xl font-bold my-4">
            Soy Pablo <span className="text-white sm:text-black">Sánchez</span>
          </h1>
          <h2 className="text-2xl font-light mt-4 sm:text-xl">
            Diseñador - Desarrollador - Freelancer
          </h2>
        ...
        <div>
          <img
            className="rounded-3xl object-scale-down h-96 sm:hidden"
            src={ProfilePhoto}
            alt=""
          />
        </div>
